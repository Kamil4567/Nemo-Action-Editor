...
void MainWindow::on_button_save_clicked()
{
    if(selectedAction != ""){
        ...
        else if(ui->radio_conditions_gsettings->isCheckable())action_conditions = QStringLiteral("gsettings %1").arg(ui->input_conditions_gsettings->text());
...
void MainWindow::assignClass(){
    //class button
    //QPushButton *buttonClass[] = {ui->button_dependencies_add, ui->button_dependencies_remove_all};
}
